...
class TeamBuilder:
    ...
    def find_best_agent_for_role(
        ...
        marketplace_agents = (
            ...
            self.search_marketplace_for_role(
                role
            )
        ...
        print(
            ...
            f"[TeamBuilder] ⚠️ "
            f"No exact available match. "
            f"Scanning verified agents..."
        ...
        return {
            ...
            "error":
                f"CRITICAL: No agents "
                f"available for role "
                f"'{role}'"
    ...
    def build_team(
        ...
        requirements = (
            ...
            self.analyze_project_requirements(
                project_brief
            )
        ...
        if total_cost > budget_usd:
            ...
            recommendations.append(
                ...
                f"Requested scope exceeds "
                f"budget by "
                f"${total_cost - budget_usd:,.0f}."
