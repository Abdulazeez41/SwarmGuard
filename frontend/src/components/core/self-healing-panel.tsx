      ...
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          ...
          <div className="mt-3 text-2xl font-semibold text-gradient-primary">
            When an agent fails, the project keeps moving.
          </div>
          <p className="mt-4 text-sm leading-7 text-slate-300/80">
            Performance bond seized. Trust score reduced. Swarm memory updated.
            Replacement search initiated. Better candidate deployed. Timeline
            and payments continue without a human coordinator stepping in.
          </p>
          <div className="mt-6 space-y-3">
            {[
              [
                "Red pulse",
                "Anomaly severity crosses threshold and lights the lane.",
              ],
              [
                "Bond seized",
                "Risk recovery capital returns to the project reserve.",
              ],
              [
                "Replacement joins",
                "The stronger candidate inherits task context and evidence requirements.",
              ],
            ].map(([title, detail]) => (
              <div
                key={title}
